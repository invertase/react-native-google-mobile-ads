...
public class ReactNativeGoogleAdsEvent implements NativeEvent {
  public static final String GOOGLE_ADS_EVENT_INTERSTITIAL = "google_ads_interstitial_event";
  public static final String GOOGLE_ADS_EVENT_REWARDED = "google_ads_rewarded_event";

  public static final String GOOGLE_ADS_EVENT_LOADED = "loaded";
  ...
  public static final String GOOGLE_ADS_EVENT_REWARDED_EARNED_REWARD = "rewarded_earned_reward";

  private static final String KEY_BODY = "body";
  private static final String KEY_REQUEST_ID = "requestId";
  private static final String KEY_GOOGLE_ADS_EVENT_UNIT_ID = "adUnitId";
  ...
  public ReactNativeGoogleAdsEvent(
  ...
  public WritableMap getEventBody() {
    ...
    event.putString(KEY_GOOGLE_ADS_EVENT_UNIT_ID, adUnitId);
