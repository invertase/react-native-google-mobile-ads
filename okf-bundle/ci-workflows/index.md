...
| Docs — **Spelling & Docs links** | [`.github/workflows/docs.yml`](../../.github/workflows/docs.yml) | [Docs validation](../testing/validation-checklist.md#lint-and-formatting) via the [canonical registry](../testing/agent-command-policy.md#canonical-registry) | CI runs `yarn lint:spellcheck` and `yarn lint:docs-links`; markdown check remains local. |
