...
class ReactNativeGoogleMobileAdsPoolModule(
  ...
  private val callbacks = HashMap<String, PreloadCallback>()
  ...
  private fun buildCallback(
    ...
    object : PreloadCallback {
      override fun onAdPreloaded(
        preloadId: String,
        responseInfo: com.google.android.libraries.ads.mobile.sdk.common.ResponseInfo,
      ) {
      ...
      override fun onAdFailedToPreload(
        ...
        sendPoolEvent(
          ...
          generation,
          "error",
          error = ReactNativeGoogleMobileAdsCommon.loadAdErrorToMap(adError),
        )
      }
    }

  private fun isSupportedFormat(format: String): Boolean = format == "appOpen" || format == "interstitial" || format == "rewarded"
  ...
  private fun buildConfiguration(
    ...
    val adRequest: AdRequest =
      ReactNativeGoogleMobileAdsCommon.buildAdRequest(adUnitId, requestOptions)
    return PreloadConfiguration(adRequest, bufferSize.coerceAtLeast(1))
  }
  ...
  override fun poolStart(
    ...
    NextGenMobileAdsGate.runWhenInitialized(
      ...
      poolStartInitialized(preloadId, format, generation, adUnitId, bufferSize, requestOptions, promise)
    }
  }

  private fun poolStartInitialized(
    preloadId: String,
    format: String,
    generation: Double,
    adUnitId: String,
  ...
  override fun poolGetAvailability(
    ...
    NextGenMobileAdsGate.runWhenInitialized(
      ...
      poolGetAvailabilityInitialized(preloadId, format, generation, promise)
    }
  }

  private fun poolGetAvailabilityInitialized(
    preloadId: String,
    format: String,
    generation: Double,
    promise: Promise,
  ...
  override fun poolPeekResponseInfo(
    ...
    NextGenMobileAdsGate.runWhenInitialized(
      ...
      poolPeekResponseInfoInitialized(preloadId, format, generation, promise)
    }
  }

  private fun poolPeekResponseInfoInitialized(
    preloadId: String,
    format: String,
    generation: Double,
    promise: Promise,
    ...
    val responseInfo =
      when (format) {
        "appOpen" -> AppOpenAdPreloader.peekAdResponseInfo(preloadId)
        "interstitial" -> InterstitialAdPreloader.peekAdResponseInfo(preloadId)
        "rewarded" -> RewardedAdPreloader.peekAdResponseInfo(preloadId)
        else -> null
      }
    promise.resolve(ReactNativeGoogleMobileAdsResponseInfo.toWritableMap(responseInfo))
  }
  ...
  override fun poolPoll(
    ...
    NextGenMobileAdsGate.runWhenInitialized(
      ...
      poolPollInitialized(preloadId, format, generation, requestId, adUnitId, promise)
    }
  }

  private fun poolPollInitialized(
    preloadId: String,
    format: String,
    generation: Double,
    requestId: Double,
        ...
        when (format) {
          "appOpen" -> {
            ...
            adoptPolledFullscreenAdOrReject(
              ...
              ad,
              promise,
            ) { resolveFilledPoll(promise, reqId, ad.getResponseInfo()) }
          }
          "interstitial" -> {
          ...
          "rewarded" -> {
            ...
            ReactNativeModule.rejectPromiseWithCodeAndMessage(
              promise,
              "pool/format-preload-unsupported",
              "Format '$format' cannot be polled on Android Next-Gen",
            )
          }
        }
      } catch (e: Exception) {
  ...
  override fun poolDestroy(
    ...
    NextGenMobileAdsGate.runWhenInitialized {
      poolDestroyInitialized(preloadId, format, generation)
    }
  }

  private fun poolDestroyInitialized(
    preloadId: String,
    format: String,
    generation: Double,
  ) {
