...
class ReactNativeGoogleMobileAdsNativeAdViewManager(
  ...
  override fun addView(
    parent: ReactNativeGoogleMobileAdsNativeAdView,
    child: View,
    index: Int,
  ) {
  ...
  override fun getChildCount(parent: ReactNativeGoogleMobileAdsNativeAdView): Int = parent.viewGroup.childCount

  override fun getChildAt(
    parent: ReactNativeGoogleMobileAdsNativeAdView,
    index: Int,
  ): View? = parent.viewGroup.getChildAt(index)
