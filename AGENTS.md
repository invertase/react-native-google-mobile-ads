...
Follow [documentation-policy § public vs ephemeral vs private](okf-bundle/documentation-policy.md#durable-vs-ephemeral). Everything under `.agents/` is a gitignored ephemeral working file — do not stage it. Do not add ephemeral files under `okf-bundle/`.
