...
The AdMob package provides hooks to help you to display ads in functional component with tiny code. The supported ad formats are full-screen-type-ads: AppOpen, Interstitial, Rewarded.
...
> `adUnitid` parameter is also can be used to manage creation and destruction of ad instance.
