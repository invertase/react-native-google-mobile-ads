...
The module supports five types of Ads:

1. Full screen [App Open Ads](/displaying-ads#app-open-ads).
2. Component based [Banner Ads](/displaying-ads#banner-ads-component).
3. Full screen [Interstitial Ads](/displaying-ads#interstitial-ads).
4. Full screen [Rewarded Ads](/displaying-ads#rewarded-ads).
5. Full screen [Rewarded Interstitial Ads](/displaying-ads#rewarded-interstitial-ads).
