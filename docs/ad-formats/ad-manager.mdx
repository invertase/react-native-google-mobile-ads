...
- `customTargeting` sends key/value pairs that Ad Manager can use in line-item targeting. Pass
  each value as a string or an array of strings.
...
Define the matching keys, values, and line-item rules in Ad Manager. The client API
