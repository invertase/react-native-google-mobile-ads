---
title: Fullscreen ads with hooks
description: Use the React hook API (useInterstitialAd and related hooks) to display fullscreen ads with minimal code.
---

# Fullscreen ads with hooks
...
show-phase failures stay `'error'`. See [v17 API reference](/rngma-v17-api-reference#inventory-emptiness-on-load).
