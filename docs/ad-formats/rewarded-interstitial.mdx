...
High-engagement rewarded chrome (close / progress) is owned by Google's `AdActivity`. See [Rewarded ads](/ad-formats/rewarded#android-rewarded-close--progress-chrome-high-engagement-creatives).
