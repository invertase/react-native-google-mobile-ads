...
**Note:** The status returned by this call tells whether the user has already
seen and replied to the consent form, rather than the actual status of his consent
...
this will likely result in failed app review upon submission to Apple Store.
