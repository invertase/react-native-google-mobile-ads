...
The React Native Google Ads module provides out of the box support for helping to manage your users consent
...
```js
import { AdsConsent } from 'react-native-google-ads';
...
```js
import { AdsConsent, AdsConsentStatus } from 'react-native-google-ads';
...
```js
import { AdsConsent, AdsConsentDebugGeography } from 'react-native-google-ads';
...
```js
import { AdsConsent, RewardedAd } from 'react-native-google-ads';
