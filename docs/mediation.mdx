...
Add the adapter's dependency to your app-level `android/app/build.gradle` file and the adapter's pod to your app-level `ios/Podfile`.
            ...
            "pods": [
              {
                ...
                "name": "Google-Mobile-Ads-Mediation-AppLovin",
                "version": "~> {X.Y.Z.A}"
              }
            ]
          }
