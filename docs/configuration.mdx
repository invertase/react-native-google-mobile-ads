...
The app IDs for Android and iOS need to be added to your project configuration. Where you put them depends on your setup:

- **Expo:** add them via the config plugin — see [Installation — Expo](/installation/expo).
- **Bare React Native:** add them to `app.json` — see [Installation — React Native CLI](/installation/react-native).
