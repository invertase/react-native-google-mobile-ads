...
- Do not retain loaded inventory indefinitely. Google documents a four-hour window for app open ads
  and a [60-minute expiry for Android
  interstitials](https://developers.google.com/admob/android/interstitial). Other formats and
  platforms do not share one universal SDK expiry. For held pooled inventory, this library applies
