---
title: Impression-level ad revenue
description: Capture paid events and impression-level revenue from Google Mobile Ads.
---
...
reference](https://invertase.github.io/react-native-google-mobile-ads/PaidEvent.html).
