---
title: Revenue telemetry and auction diagnostics
description: Inspect response metadata, mediation waterfalls, and paid-event telemetry.
---
...
[generated `ResponseInfo` reference](https://invertase.github.io/react-native-google-mobile-ads/ResponseInfo.html).
...
- [Common reasons ads do not show](/common-reasons-for-ads-not-showing) — account and setup fill issues
...
- [Generated `ResponseInfo` reference](https://invertase.github.io/react-native-google-mobile-ads/ResponseInfo.html) — canonical types
