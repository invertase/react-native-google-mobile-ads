...
description: Install and configure React Native Google Mobile Ads in a bare React Native project.
---
...
## Configure your App IDs

Before you can display ads you must have a [Google AdMob account](https://apps.admob.com) and an App ID for each platform —
see [Configuration](/configuration) for where to find the App ID. For bare React Native projects, add the app IDs to the
`app.json` file at the root of your project:
...
You may need this if you use this module in combination with `react-native-firebase` (see
