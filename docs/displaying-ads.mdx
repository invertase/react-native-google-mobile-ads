...
```js
import { InterstitialAd, TestIds, AdEventType } from 'react-native-google-ads';
...
import { InterstitialAd, AdEventType, TestIds } from 'react-native-google-ads';
...
```js
import { RewardedAd, TestIds } from 'react-native-google-ads';
...
import React, { useEffect, useState } from 'react';
import { Button } from 'react-native';
import { RewardedAd, RewardedAdEventType, TestIds } from 'react-native-google-ads';
...
import { BannerAd, BannerAdSize, TestIds } from 'react-native-google-ads';
