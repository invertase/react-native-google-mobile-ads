...
* **facebook:** expose `setAdvertiserTrackingEnabled` / `setDataProcessingOptions` before GMA initialize ([#828](https://github.com/invertase/react-native-google-mobile-ads/issues/828))
...
* **ios:** expose `mobileAds().setAudioSessionIsApplicationManaged` for page/ad video audio coexistence ([#840](https://github.com/invertase/react-native-google-mobile-ads/issues/840))
...
* **deps:** update Google Mobile Ads SDK to iOS 13.5.0 and Android 25.4.0 ([c8b3549](https://github.com/invertase/react-native-google-mobile-ads/commit/c8b3549eb98b63fc4656a972bbc6c6e2f5d8f0df))
...
* **deps:** bump Google Mobile Ads SDK (iOS 13.1.0, Android 25.0.0) ([7358f40](https://github.com/invertase/react-native-google-mobile-ads/commit/7358f407a7acbfbdebb6be9ac61f775e45350c4a))
